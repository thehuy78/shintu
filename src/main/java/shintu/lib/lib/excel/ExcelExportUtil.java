...
public class ExcelExportUtil {
  public static <T> CustomResult export(List<T> data, Class<T> clazz, String sheetName) {
    try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
      ...
      return new CustomResult(200, "Export Success", Base64.getEncoder().encodeToString(out.toByteArray()));
